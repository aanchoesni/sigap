...
@section('content')
{!! Form::open(array('url' => route('building.store'), 'method' => 'POST', 'id' => 'building', 'class' => 'form-horizontal')) !!}
{!! csrf_field() !!}
<!-- page start-->
<div class="row">
	<div class="col-md-9">
	    <div class="panel panel-default">
	        <div class="panel-heading">
	            <h3 class="panel-title"><strong>Add</strong> Building</h3>
	        </div>
	            ...
	            <div class="row">
	                <div class="col-md-12">
	                    ...
	                    <div class="form-group @if ($errors->has('lat')) has-error @endif">
	                        ...
	                        <div class="col-md-10">
                              {{ Form::text('lat', null, array('class' => 'form-control', 'id'=>'lat', 'readonly')) }}
	                          @if ($errors->has('lat'))
	                    ...
	                    <div class="form-group @if ($errors->has('lng')) has-error @endif">
	                        ...
	                        <div class="col-md-10">
                              {{ Form::text('lng', null, array('class' => 'form-control', 'id'=>'lng', 'readonly')) }}
	                          @if ($errors->has('lng'))
